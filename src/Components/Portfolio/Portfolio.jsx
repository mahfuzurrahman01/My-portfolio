    ...
    return (
        ...
        >
            ...
            <div className='flex justify-center items-center gap-6 flex-wrap'>
                ...
                =========================== E-commerce section =================
                ============================================================== */}
                <div data-aos="zoom-in-right" data-aos-duration="1000" onMouseEnter={() => mouseEnterHandle(1)} onMouseLeave={mouseLeaveHandle} className='md:w-[32%] w-full flex-col relative overflow-hidden bg-gray-900 bg-gradient-to-tl from-slate-500 rounded-lg flex justify-center items-center h-72'>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" onMouseEnter={() => mouseEnterHandle(2)} onMouseLeave={mouseLeaveHandle} className='md:w-[32%] w-full flex-col relative overflow-hidden bg-gray-900 bg-gradient-to-tl from-slate-500 rounded-lg flex justify-center items-center h-72'>
                    {/* This div will work as cover  */}
                ...
                <div data-aos="zoom-in-left" data-aos-duration="1000" onMouseEnter={() => mouseEnterHandle(3)} onMouseLeave={mouseLeaveHandle} className='md:w-[32%] w-full flex-col relative overflow-hidden bg-gray-900 bg-gradient-to-tl from-slate-500 rounded-lg flex justify-center items-center h-72'>
                    {/* This div will work as cover  */}
