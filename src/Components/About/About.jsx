                    ...
                    <div className="container max-w-5xl px-4 py-12 mx-auto">
                        <div className="grid gap-4 mx-4 sm:grid-cols-12">
                            <div className="col-span-12 sm:col-span-3">
                                <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-slate-500">
                            ...
                            <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                                <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700">
                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-slate-500">
                                        ...
                                        <p className="mt-3">Throughout this course, I have gained invaluable knowledge and skills in building full-stack web applications using MongoDB, Express.js, React, and Node.js. I've learned how to create dynamic user interfaces, integrate APIs, manage databases and deploy the site</p>
                                    </div>
                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-slate-500">
                                        <div className='flex justify-between items-center'>
                                        ...
                                        <p className="mt-3">From this course I've learned CSS3 deeply.And get familiar with css Box model, flex box, selector and many more deeply.And explore how they works in browser.</p>
                                    ...
                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-slate-500">
                                        ...
                                        <p className="mt-3">From this course I've learned about the different types of web developers and the roles and responsibilities of front-end, back-end, and full-stack developers. I've take a first look at the core technologies of HTML, CSS, and Javascript and explore the concepts that underpin how the internet works.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                                <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700">
                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-slate-500">
                                        ...
                                        <p className="mt-3">I'm building the Zeigen frontend.Zeigen is a health care service providing website.It is designed to promote and sell healthcare services provided by doctors and other medical professionals, such as consultations, appointments, and test lists. The website will likely include information about the services offered, pricing, and details about the healthcare providers. Users can book appointments and take advantage of the healthcare services offered through the website</p>
                                    </div>
                                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-slate-500">
                                        <div className='flex justify-between items-center'>
                                        ...
                                        <p className="mt-3">I've done my internship from calciteX as a reactJs developer.It was 2 months of internship program.Where my main task was to build the UI with React and make reusable components.In this period I've build 3 CRM website UI with reactJs and work on some existing projects also.</p>
                                    </div>
